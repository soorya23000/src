...
<head>
    ...
    <title>"Exercise 1: Getting Started with PHP-Soorya Rasandi"</title>
    
    <?php
$title = "Exercise 1: Getting Started with PHP-Soorya Rasandi";
include 'header.php' ?> ;
...
<h3>3.3 Define three variables: $g1 = 5, $g2 = 4, and $g3 = 5. These variables represent the grades of three students in the course. 
 ...
 <table>
    ...
    <img src="images/24png.png" alt="web development environment" height="150px" width="1000px">
    </div>
    </div>
